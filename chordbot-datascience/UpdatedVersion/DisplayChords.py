from ChordFunctions import extractChords
...
for pattern in extractChords(Load_MLmodel, userSong):	#calling the function from ChordFunctions to get the chord pattern
